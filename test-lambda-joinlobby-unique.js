...
async function testJoinLobbyWithUniqueUsername() {
  console.log('🧪 Testing joinLobby with unique username...\n');
  ...
  try {
    console.log('📤 Sending request with unique username:', uniqueUsername);
...
testJoinLobbyWithUniqueUsername(); 
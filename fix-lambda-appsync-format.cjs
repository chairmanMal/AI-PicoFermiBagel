...
async function fixLambdaAppSyncFormat() {
  console.log('🔧 Fixing Lambda function to handle AppSync event format...\n');
  
  // The corrected code that handles both AppSync formats

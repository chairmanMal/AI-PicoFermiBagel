...
async function handleDifficultyInterestUpdate(input) {
  ...
  try {
    ...
    const params = {
      ...
      Key: { difficulty },
      UpdateExpression: 'SET interestCount = if_not_exists(interestCount, :start) + :inc, lastUpdated = :timestamp',
    ...
    console.log(`🎮 Successfully updated difficulty interest. New count: ${newInterestCount}`);
